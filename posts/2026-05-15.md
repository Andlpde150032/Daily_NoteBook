...
### 1. Cuộc chiến với những "Chìa khóa cũ" (Password Rotation)
Sau khi xác định tài khoản `Administrator` đã bị thỏa hiệp, hành động đầu tiên là thay đổi thông tin xác thực để cắt đứt quyền truy cập dựa trên thông tin cũ.

*   **Thao tác:** Sử dụng lệnh `net user Administrator [NewPassword]` trên máy chủ.
*   **Kết quả:** Ngăn chặn thành công các yêu cầu đăng nhập **MỚI** từ máy của kẻ tấn công.

![Thực hiện đổi mật khẩu Administrator để thu hồi quyền truy cập](../proof/1505/defender_step_1.png)

### 2. Sự thật về "Bóng ma Session" (Session Persistence)
...
### 3. Xây tường cao, hào sâu (Firewall Hardening)
...
### 4. Kiểm chứng thực tế (Validation)
